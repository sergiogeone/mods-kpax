...
// Begin Author: rviguera
    ...
    public function addGame($campusSession, $name, $idGame, $idCategory, $creationDate, $developer) {
        $body = 'secretSession=' . $campusSession . '&name=' . $name . '&idGame=' . $idGame . "&idCategory=" . $idCategory . "&creationDate=" . $creationDate . "&developer=" . $developer;
        return $this->service("game/add", "POST", $body);
    }
