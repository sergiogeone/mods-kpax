...
$english = array(
    ...
    'kPAX:game:images' => "Insert as many images as you want, put the URLs separated by a space",
    'kPAX:game:logo' => "Logo (square image url)",
    'kPAX:game:banner' => "Game banner (image url)",
    'kPAX:game:videourl' => "Youtube url video",
